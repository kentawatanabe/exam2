...
Devise.setup do |config|
  ...
  # by default. You can change it below and use your own secret key.
   config.secret_key = 'e75bbb87b96f3ff4fe6d93ccd460b4e4cad75b1f956bbc64360df4fde63328d2248ac0b5a34ac45ec3d37c97650c2faac4ee2f9185ce436e7dfbd30c9d091956'
  ...
  # config.pepper = '577f2062c2729745267963f6b051971209a07930decd256e44c0ebdb780c1e4c0060a7cb4ad60729e3ba6a895543f5c4aab85c80ea8f1f0314731c63f3852b65'
  ...
  if Rails.env.production?
    ...
    config.omniauth :twitter, ENV["TWITTER_ID_PRODUCTION"], ENV["TWITTER_SECRET_PRODUCTION"], scope: 'email', display: 'popup', into_fields: 'name, email'
  else
